...
Um den Adobe Experience Platform Debugger auszuführen, klicken Sie auf das Symbol in Ihrer Browserleiste und öffnen Sie dann die Seite, die Sie im Browser untersuchen möchten.

![](assets/start-icon.jpg)

Der Bildschirm &quot;Adobe Experience Platform Debugger-Zusammenfassung&quot;wird angezeigt.
...
<table id="table_DC76D63FA6EF4891906B9E1D3E4A8A6C"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Die Nummer der AEB Web SDK- <a href="https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/aep-extension/overview.html" format="html" scope="external">Bibliotheksversion</a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Namensraum</p> </td> 
   <td colname="col2"> <p>Der in der Erweiterung angegebene Name</p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Eigenschafts-ID </p> </td> 
   <td colname="col2"> <p>Der Name der in der Erweiterung angegebenen Eigenschaft "Launch" </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Kennung der IMS-Organisation </p> </td> 
   <td colname="col2"> <p>Die Organisation, an die die Daten gesendet werden sollen, wie in der Erweiterung angegeben </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Protokollierung aktiviert </p> </td> 
   <td colname="col2"> <p>Gibt an, ob die Protokollierung für diese Eigenschaft aktiviert wurde</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D30E0CD20FB04E41862B22655136E043"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Der Typ des <a href="https://docs.adobe.com/content/help/en/launch/using/extensions-ref/adobe-extension/target-extension/overview.html" format="html" scope="external">Ereignisses</a> , das beim Laden der Seite ausgelöst wird </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Anforderungsname </p> </td> 
   <td colname="col2"> <p>The name of a request around a <a href="https://docs.adobe.com/content/help/en/target/using/implement-target/client-side/mbox-implement/global-mbox/understanding-global-mbox.html" format="html" scope="external"> location</a> on the page. Ist nur dann ohne Authentifizierung verfügbar, wenn Sie den Debugging-Ereignis-Listener in Ihren Code oder Tag-Manager implementieren und die erforderlichen <a href="https://docs.adobe.com/content/help/en/target/using/administer/response-tokens.html" format="html" scope="external">Antwort-Tokens</a> in der Target-Benutzeroberfläche aktivieren. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>Erlebnisname </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die ID des Erlebnisses "Zielgruppe". Ist nur dann ohne Authentifizierung verfügbar, wenn Sie den Debugging-Ereignis-Listener in Ihren Code oder Tag-Manager implementieren und die erforderlichen <a href="https://docs.adobe.com/content/help/en/target/using/administer/response-tokens.html" format="html" scope="external">Antwort-Tokens</a> in der Target-Benutzeroberfläche aktivieren. </p> </td> 
  </tr> 
  <tr> 
